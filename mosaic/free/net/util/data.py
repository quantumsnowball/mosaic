...
from mosaic.free.net.util.mosaic import get_random_parameter
...
def get_transform_params():
    ...
    flag_dict = {'crop': crop_flag, 'rotat': rotat_flag,
                 'color': color_flag, 'flip': flip_flag, 'degradate': degradate_flag}
    ...
    rate_dict = {'crop': crop_rate, 'rotat': rotat_rate, 'color': color_rate,
                 'flip': flip_rate, 'degradate': degradate_params}
